...
#define BUILDING_MISC_MAX			1

#define BUILDING_HEAVY_LASERMASER		1
#define BUILDING_BALLISTIC_DEFENDER		2
#define BUILDING_MILITARY_BASE			3
#define BUILDING_WEAPON_MAX			4

#define BUILDING_INSTELATION_COLLECTOR		4
#define BUILDING_GENERATOR_MAX			5

#define BUILDING_MAX				5
